...
export default function CopartFlipCalculator() {
  ...
  return (
    <div style={{ background: COLORS.bg, minHeight: "100%", color: COLORS.text, fontFamily: "'Inter', sans-serif" }} className="w-full">
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Oswald:wght@500;600;700&family=Inter:wght@400;500&family=JetBrains+Mono:wght@400;500;700&display=swap');
          ...
          >
            <svg width="30" height="30" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
              <g transform="translate(50,50)">
                <circle cx="0" cy="0" r="30" fill="none" stroke={COLORS.yellow} strokeWidth="2" opacity="0.45" />
                <circle cx="0" cy="0" r="20" fill="none" stroke={COLORS.yellow} strokeWidth="2" opacity="0.7" />
                <circle cx="0" cy="0" r="9" fill="none" stroke={COLORS.yellow} strokeWidth="2" />
                <line x1="0" y1="0" x2="0" y2="-30" stroke="#4FE0FF" strokeWidth="3" />
                <circle cx="0" cy="0" r="3.5" fill="#4FE0FF" />
              </g>
            </svg>
          </div>
          <div>
            <h1 style={{ fontFamily: "'Oswald', sans-serif", fontSize: 22, letterSpacing: "0.14em", fontWeight: 700 }}>
              RADAR
            </h1>
            <p style={{ color: COLORS.muted, fontSize: 10.5, letterSpacing: "0.15em" }}>AUCTION BROKER</p>
          </div>
        </div>
        <p style={{ color: COLORS.muted, fontSize: 11.5, letterSpacing: "0.04em" }} className="mt-2">Compra → Daños → Venta → Margen</p>
      </div>
